...
from app.schemas.payment_schema import PaginatedPaymentResponse, PaymentDetailRead
...
@router.get("/paginated/list", response_model=PaginatedPaymentResponse)
def get_paginated_supplier_payments(
    ...
    return service.get_all_payments_by_supplier_paginated(
        supplier_id=current_supplier.supplier_id,
