    ...
    GUIDE_TOPICS = {
        ...
        "submit for approval": {
            ...
            "steps": [
                ...
                "After submission, watch the Tasks icon and notification bell for approval updates.",
                "Approvers should sign in, open their task or approval notification, review the details, then approve or reject manually.",
            ],
            "actions": [
                ("Create PR", "/purchase-requests/new"),
                ("View POs", "/purchase-orders"),
                ("View Invoices", "/invoices"),
                ("View Payments", "/payments"),
                ("View Approvals", "/approvals"),
