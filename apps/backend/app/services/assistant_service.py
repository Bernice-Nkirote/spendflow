    ...
    GUIDE_TOPICS = {
        "getting started": {
            ...
            "steps": [
                ...
                "Create users after roles and departments are clear so approvers and creators have the right access.",
        ...
        "purchase requisitions": {
            ...
            "steps": [
                ...
                "Open the draft using View, review totals, then submit for approval yourself.",
                "Cancel the PR if it should not continue.",
            ],
            "actions": [
        ...
        "purchase orders": {
            ...
            "guardrail": "I can suggest suppliers and next steps, but I will not create or submit the PO. Invoices need the PO to be sent to supplier or marked as shared.",
        },
        "suppliers": {
        ...
        "business types": {
            ...
            "steps": [
                ...
                "Partnership approval options only appear when the workspace business type is Partnership.",
            ],
            "actions": [
                ("Approval Workflows", "/approval-workflows"),
                ("User Guide", "/user-guide"),
        ...
        "users": {
            "keywords": ("user", "users", "create user", "add user", "invite user", "setup user", "new user"),
            "answer": "Users need the right role and department before approvals make sense. Set them up carefully and Tendaflow becomes much calmer.",
            "steps": [
                "Open Users.",
                "Create the user with name, email, role, and department.",
                "Choose a role that matches their work: Procurement, Finance, Approver, Partner, or Admin.",
                "Choose the department that matches the workflow or records they will handle.",
                "The user receives a setup email to create their password.",
                "Test with that user before relying on the workflow live.",
            ],
            "actions": [
                ("Open Users", "/users"),
                ("Open Roles", "/roles"),
            ...
            "guardrail": "Admin can access many modules, but they only see approval queue items when the workflow actually assigns approval work to them.",
        },
        "departments": {
        ...
        "roles": {
            ...
            "steps": [
                ...
                "Open Permissions if you need to assign or remove what each role can view, create, approve, export, or administer.",
            ...
            "guardrail": "Permissions are created by Tendaflow by default. Admins assign or remove permissions; they do not create new permission names from the UI.",
        },
        "permissions": {
            ...
            "steps": [
                ...
                "Assign or remove permissions from roles based on job responsibility.",
            ...
            "guardrail": "You cannot create new permissions from the UI; Tendaflow creates permission names by default so admins can assign or remove them.",
        },
        "invoices": {
            ...
            "steps": [
                ...
                "Confirm the approved PO has been sent to supplier or marked as shared with supplier.",
            ...
            "guardrail": "I cannot approve or reject invoices for you. If the PO was not sent or marked as shared, create the invoice after that step is complete.",
        },
        "payments": {
        ...
        "submit for approval": {
            ...
            "answer": "To submit something for approval, open the record you created, review it carefully, then use its submit action. After that, Tendaflow sends it into the configured approval workflow.",
            "steps": [
                "Create or open the PR, PO, invoice, or payment record.",
                "Check the supplier, department, currency, line items, totals, attachments, and notes.",
                "Click the submit action on that record when everything looks correct.",
                "After submission, watch the Tasks icon for next allowed work and the notification bell for approval alerts.",
                "Approvers should sign in, open their approval notification or approval queue item, review the details, then approve or reject manually.",
                "If rejecting, add a clear comment so the requester knows what to fix.",
            ],
            "actions": [
                ("Create PR", "/purchase-requisitions/new"),
                ("View POs", "/purchase-orders"),
            ...
            "guardrail": "I can guide you to submit, but I cannot submit, approve, reject, or pay on your behalf.",
        },
        "approvals": {
            "keywords": ("approve", "approval", "approvals", "reject", "task", "tasks", "task icon", "notification", "notification bell", "bell"),
            "answer": "You are not lost. Tasks show next work you are allowed to do, while the notification bell shows approval alerts when you are the approver.",
            "steps": [
                "Check the Tasks icon for completed upstream work you are allowed to act on, such as creating a PO from an approved PR.",
                ...
                "If rejecting, add a comment. The comment explains what should be corrected.",
            ],
            "actions": [("View Approvals", "/approvals")],
            "guardrail": "I can help you review, but I cannot approve or reject anything. Rejections require a comment.",
        },
        "approval workflows": {
            ...
            "steps": [
                ...
                "For sole proprietorship, keep the owner/admin role on the route so one-person approval works.",
        ...
        "exchange rates": {
            ...
            "steps": [
                "Open Exchange Rates.",
                "Add a manual finance-approved rate or sync supported rates from the configured API.",
            ...
            "guardrail": "Use accurate rates before creating foreign-currency records. Only overwrite manual finance-approved rates when finance agrees.",
        },
        "reports": {
            "keywords": ("report", "reports", "spend", "supplier spend", "lead time"),
            "answer": "Reports are where the story of procurement becomes visible: spend, payments, suppliers, outstanding invoices, supplier categories, and lead time.",
            "steps": [
                "Open Reports.",
                ...
                "Supplier lead time is shown as practical time, such as same day, hours, or whole days.",
            ],
