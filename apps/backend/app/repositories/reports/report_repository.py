...
class ReportRepository:
        ...
        query = (
            self.db.query(
                ...
                (
                    ...
                    * func.coalesce(Invoice.exchange_rate, 1)
    ...
    def get_outstanding_invoice_report_rows(
        ...
        base_total_amount = func.coalesce(Invoice.base_amount, 0)
        base_amount_paid = func.coalesce(func.sum(func.coalesce(Payment.base_amount, 0)), 0)
        base_outstanding_amount = base_total_amount - base_amount_paid
        ...
        query = (
            self.db.query(
                ...
                Invoice.currency.label("currency"),
                Invoice.base_currency.label("base_currency"),
                base_total_amount.label("base_total_amount"),
    ...
    def get_supplier_spend_report_rows(
        ...
        invoice_totals_subquery = (
            self.db.query(
                ...
                func.coalesce(
                    func.sum(func.coalesce(Invoice.base_amount, 0)),
                    0,
                ).label("base_total_invoice_amount"),
        ...
        payment_totals_subquery = (
            self.db.query(
                ...
                func.coalesce(
                    func.sum(func.coalesce(Payment.base_amount, 0)),
                    0,
                ).label("base_total_paid_amount"),
    ...
    def get_supplier_spend_detail_invoices(
        ...
        base_total_amount = func.coalesce(Invoice.base_amount, 0)
        base_amount_paid = func.coalesce(
            func.sum(func.coalesce(Payment.base_amount, 0)),
            0,
        )
        base_outstanding_amount = base_total_amount - base_amount_paid
        ...
        query = (
            self.db.query(
                ...
                (
                    ...
                    * func.coalesce(PurchaseRequisition.exchange_rate, 1)
                ).label("base_line_total"),
            )
            .outerjoin(
                Department,
        ...
        query = (
            self.db.query(
                ...
                (
                    ...
                    * func.coalesce(PurchaseOrder.exchange_rate, 1)
                ).label("base_line_total"),
