...
const guideSections: GuideSection[] = [
  {
    ...
    steps: [
      ...
      "Create roles for the users who will request, approve, buy, finance, or administer.",
      "Assign permissions carefully to each role.",
  ...
  },
  {
    ...
    summary:
      "The supplier portal lets external suppliers view POs, create invoices from eligible POs, and track invoices or payments.",
    whoUsesIt: "External supplier users and internal teams reviewing supplier submissions.",
    steps: [
      "Supplier users sign in through the supplier login.",
      "Suppliers view purchase orders assigned to them.",
      "Suppliers create invoices from eligible POs.",
