  ...
  if (isOverlay) {
    return (
      <>
        ...
        {isSearchOpen && (
          <div className="fixed inset-0 z-[80] bg-gray-700/25 px-3 pt-4 backdrop-blur-md">
            <div className="mx-auto w-full max-w-md rounded-3xl border border-gray-200 bg-white p-3 shadow-2xl">
              <div className="flex h-12 items-center rounded-2xl border border-grey/50 bg-white/55 px-3 shadow-lg shadow-blue-100/20 backdrop-blur-lg">
              ...
              {searchQuery.trim().length >= 2 && (
                <div className="mt-3 max-h-[70vh] overflow-y-auto rounded-2xl border border-gray-100 bg-white p-3 [scrollbar-width:thin] [scrollbar-color:rgba(39,76,119,0.35)_transparent]">
                  {renderResults()}
                </div>
              )}
            </div>
